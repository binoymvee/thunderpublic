...
def installService(request):
    ...
    services = ['thunder', 'cobbler', 'chef_server']
    ...
    for serviceName in services:
        ...
        try:
            ...
            if executionResult['status'] == False:
                ...
                progress = installationStatusObj.progress + int(100 / 3)
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                try:
                    ...
                    # Calls the function to save the data to thunder settings file and chef knife.rb
                    installationDataSetUP("knife.rb", {"host_ip" : serverIp},
                                          "/opt/thunder_web/chef-repo/.chef/knife.rb")

                    # Checks whether thunder access is set
                    if accessStatus.status:

                        # Calls the function to save the data to thunder settings file
                        installationDataSetUP("thunder_settings", {"thunder_host_ip" : thunderAccessObj.ip_address,
                                                           "pxe_ip" : serverIp},
            ...
            if form.is_valid():
                ...
                if pxestatus.status == False:
                    ...
                    try:
                        ...
                        # Calls the function to save the data to thunder settings file
                        installationDataSetUP("thunder_settings", {"thunder_host_ip" : thunderIp,
                                                           "pxe_ip" : pxeObj.ip},
                                             "/opt/thunder_web/thunder/settings.py")
                        ...
                        # Calls the function to save the data to thunder settings file and chef knife.rb
                        installationDataSetUP("knife.rb", {"host_ip" : pxeObj.ip},
                                              "/opt/thunder_web/chef-repo/.chef/knife.rb")
