...
THUNDER_PORT = '9000'
CHEF_SERVER_IP = '172.17.4.61'
THUNDER_HOST = '172.17.4.61'
LOCAL_REPO_IP = '172.17.4.61:8080'
THUNDER_ABS_PATH = "/project/leon"
...
PATCH_UPLOAD_PATH = "/project/leon/patches/"
DB_PATCH_UPLOAD_PATH = "/project/leon/db/"
PATCH_ROLLBACK_PATH = "/opt/thunder_rollback/thunder_web/"
DB_PATCH_ROLLBACK_PATH = "/project/leon/db/rollback/"
PATCH_RELEASE_FILE_PATH = "/project/leon/patches/RELEASES.txt"
PATCH_INSTALL_SH_FILE_PATH = "/project/leon/patches/"
PATCH_ROLLBACK_SH_FILE_PATH = "/project/leon/patches/rollback/"
...
SYS_OS_PASS = "geo@678"
SYS_OS_SUDO = True
PASSWORD_MASTER_KEY="Some-long-base-key-to-use-as-encyrption-key"
